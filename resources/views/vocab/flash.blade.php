...
<div id="main-vocab">
    <div class="flash-card" id="word-card">
            <div class="float-left">
                <h3><span class="badge badge-pill badge-primary" id="num">1</span></h3>
            </div>
            <div class="float-right">
                <span>Score : <span class="badge badge-info score">0/0</span></span><br>
            </div>
        <div class="word-header mt-5" align="center">
            <h3 id="word">1</h3> <br>(<span id="word-type">1</span>)
        </div>
        <div align="center">
        <button class="btn btn-primary mt-3 show-btn" onclick="$(this).hide();$('#word-meaning').removeClass('d-none')"><i class="material-icons" style="font-size: 16px;position: relative;top: 3px;">visibility</i> show</button> <h3 class="d-none mt-3" id="word-meaning">คำแปล</h3>
        </div>
        <br>
